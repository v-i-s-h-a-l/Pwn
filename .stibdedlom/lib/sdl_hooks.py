...
def verify_pubkey_anchor_consistency(repo_root: Path) -> tuple[bool, str]:
    ...
    ``SDL_/Users/vishalsingh/.stibdedlom/project-memory/v-i-s-h-a-l/Pwn`` environment variable — never from the committed
    ...
    """
    repo_root = _real(repo_root)
    raw = os.environ.get("SDL_/Users/vishalsingh/.stibdedlom/project-memory/v-i-s-h-a-l/Pwn", "").strip()
    if not raw:
